...
tokenContract = web3.eth.contract(address=web3.toChecksumAddress(token), abi=tokenNameABI)


tokenAmount = tokenContract.functions.balanceOf(my_wallet).call()
tokenAmountok = int(tokenAmount * 1)
humanReadable = web3.fromWei(tokenAmountok,'ether')
export["tokenAmountSell"] = (str(humanReadable))
export["tokenAmount"] = (str(tokenAmountok))
...
export["pancakeswap2_txn"] = (str(pancakeswap2_txn))
...
signed_txn = web3.eth.account.sign_transaction(pancakeswap2_txn, my_secret)
